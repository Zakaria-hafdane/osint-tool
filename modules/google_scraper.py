...
def search_email_google(email, num_results=10):
    queries = [
    ...
    for query in queries:
        ...
        time.sleep(random.uniform(2, 4))  # Random delay between queries
